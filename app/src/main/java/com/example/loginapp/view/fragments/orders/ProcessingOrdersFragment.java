...
import com.example.loginapp.databinding.FragmentOrdersProcessingBinding;
import com.example.loginapp.model.entity.Order;
import com.example.loginapp.presenter.ProcessingOrdersPresenter;
import com.example.loginapp.view.commonUI.LoadingDialog;

import java.util.List;

public class ProcessingOrdersFragment extends Fragment implements OnOrderClickListener, OrderView {

    private final ProcessingOrdersPresenter presenter = new ProcessingOrdersPresenter(this);
