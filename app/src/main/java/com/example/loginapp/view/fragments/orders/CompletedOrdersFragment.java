...
import com.example.loginapp.presenter.CompletedOrdersPresenter;
import com.example.loginapp.view.commonUI.LoadingDialog;

import java.util.List;

public class CompletedOrdersFragment extends Fragment implements OnOrderClickListener, OrderView {

    private final CompletedOrdersPresenter presenter = new CompletedOrdersPresenter(this);
