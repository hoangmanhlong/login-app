...
public class ProcessingOrdersPresenter implements OrderListener {
    ...
    public ProcessingOrdersPresenter(OrderView view) {
        this.view = view;
    }
    ...
    public void getOrders(List<Order> orders) {
        this.orders = orders.stream()
                .filter(p -> p.getOrderStatus() == OrderStatus.Processing)
